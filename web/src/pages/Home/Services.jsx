...
const Services = () => {
  ...
  return (
    <section ref={ref} className="grid grid-cols-1 px-4 pb-16 lg:grid-cols-3">
      <MotionConfig transition={{ duration: 1.3, ease: "backInOut" }}>
        ...
        <motion.div
          ...
          className="flex flex-col lg:flex-row lg:order-1"
        >
        ...
        <motion.div
          initial={{ opacity: 0, x: "200px" }}
          animate={isInView ? { opacity: 1, x: 0 } : {}}
          className="flex flex-col lg:flex-row lg:order-3"
        >
