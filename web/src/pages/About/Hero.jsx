...
const Hero = () => {
	return (
		<section className="relative flex flex-col items-center justify-center py-16 space-y-4 overflow-hidden xl:flex-row bg-gradient-to-r from-accent-primary to-to-foreground">
			...
			<motion.div
				...
				transition={{ duration: 1.2 }}
				className="flex justify-center lg:opacity-60"
			>
				<img
