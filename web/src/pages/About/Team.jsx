...
const Team = () => {
	return (
		<section className="flex flex-col justify-center w-full bg-[#EEE3A9] p-20">
			{/* Heading */}
			<div>
			...
			{/* Team info */}
			<div className="grid items-center self-center max-w-4xl grid-cols-1 gap-12 p-8 rounded-lg w-fit lg:grid-cols-4">
